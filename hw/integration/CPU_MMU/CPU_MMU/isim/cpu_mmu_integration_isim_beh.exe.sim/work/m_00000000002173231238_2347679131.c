...
LAB489:    t1043 = *((unsigned int *)t1012);
    t1044 = (~(t1043));
...
LAB488:    t1041 = (t0 + 7128U);
    t1042 = *((char **)t1041);
    goto LAB489;

LAB490:    t1041 = (t0 + 1368U);
    t1049 = *((char **)t1041);
    t1041 = ((char*)((ng30)));
    memset(t1050, 0, 8);
    t1051 = (t1049 + 4);
...
LAB504:    t1073 = (t1048 + 4);
    t1074 = *((unsigned int *)t1048);
    t1075 = *((unsigned int *)t1073);
    t1076 = (t1074 || t1075);
    if (t1076 > 0)
        goto LAB505;

LAB506:    t1079 = *((unsigned int *)t1048);
    t1080 = (~(t1079));
...
LAB510:    if (*((unsigned int *)t1048) > 0)
        goto LAB511;

LAB512:    memcpy(t1047, t1083, 8);

LAB513:    goto LAB491;

LAB492:    xsi_vlog_unsigned_bit_combine(t1011, 32, t1042, 32, t1047, 32);
    goto LAB496;

LAB494:    memcpy(t1011, t1042, 8);
    goto LAB496;
...
LAB501:    *((unsigned int *)t1048) = 1;
    goto LAB504;

LAB503:    t1072 = (t1048 + 4);
...
LAB509:    xsi_vlog_unsigned_bit_combine(t1047, 32, t1078, 32, t1083, 32);
    goto LAB513;

LAB511:    memcpy(t1047, t1078, 8);
    goto LAB513;
...
extern void work_m_00000000002173231238_2347679131_init()
{
	...
	xsi_register_didat("work_m_00000000002173231238_2347679131", "isim/cpu_mmu_integration_isim_beh.exe.sim/work/m_00000000002173231238_2347679131.didat");
